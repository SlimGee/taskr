            ...
            <div class="w-5/12">
                <form action="{{ route('tasks.update', $task) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <x-form.input name="title" class="mt-1 w-full" placeholder="Do the thing" :value="old('title', $task->title)"
                            error='title' />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <x-form.select name="status" class="mt-1 w-full" error="status">
                    ...
                    <div class="mb-3">
                        ...
                        <x-form.textarea name="description" class="mt-1 w-full"
                            error="description">{{ old('description', $task->description) }}</x-form.textarea>

                    </div>

                    <div>
                        <x-button type="submit">Update task</x-button>
                    </div>
